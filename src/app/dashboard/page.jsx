...
export default function Home() {
  ...
  const [memoryTypeFilter, setMemoryTypeFilter] = useState('NAND'); // DRAM 필터 기본값 설정
  ...
  return (
    <main>
      ...
      <nav className={`navbar ${isScrolled ? 'scrolled' : ''}`}>
        <div className="navbar-container">
          ...
          <div className={`navbar-menu ${isMobileMenuOpen ? 'mobile-open' : ''}`}>
            <a href="/" className="navbar-link">DRAM ROUTE</a>
            <a href="/dashboard" className="navbar-link active" onClick={handleDashboardClick}>NAND ROUTE</a>
      ...
      <div className="dashboard-container">
        <h1 className="dashboard-title">NAND ROUTE MASTER</h1>
